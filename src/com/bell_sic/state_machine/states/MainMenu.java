...
public class MainMenu extends UIState {
    public MainMenu() {
        ...
        addOperation("admin menu", () -> UILoop.setTransition(Transition.GoToAdminMenu), ReadHospitalInfoPermission.get());
        addOperation("Exit", UILoop::breakLoop, ExitPermission.get());
    }
